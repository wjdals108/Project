        ...
        <main class="todo-main">
            <div class="input-section">
                <form action="/add" method="POST">
                    <input type="text" name="item" class="item" placeholder="오늘의 할 일을 입력하세요" autofocus="true" required>
                    <div class="input-section-btn">
                        <button type="submit" id="add_btn"><img src="./assets/add.png" alt="add button"></button>
                    </div>
                </form>
            </div>
            <div class="todo-list">
                    ...
                    <li id="${item.i_todo}">
                        ...
                        <div class="list-btn">
                            ...
                            <label for="check_box${item.i_todo}" id="check_btn" >
                            	<img src="./assets/check.png" alt="check button">
                            </label>
                            <button id="del_btn">
                            	<a href="/del?i_todo=${item.i_todo}">
                                	<img src="./assets/del.png" alt="delete button">
                                </a>
                            </button>
                        </div>
                    </li>
